        ...
        <div class="card shadow-sm h-100">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <i class="bi bi-person-check fs-2 me-3 text-primary"></i> <div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="card-text fs-4 mb-0">{{ \App\Models\Alternatif::count() }}</p>
                    </div>
                </div>
            </div>
            <div class="card-footer bg-transparent border-top-0">
                <a href="{{ route('alternatif.index') }}" class="btn btn-sm btn-outline-info">Kelola Alternatif</a>
            </div>
        </div>
    </div>
