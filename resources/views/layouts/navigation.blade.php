<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        {{-- Keterangan Halaman / Breadcrumb --}}
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Pages</a></li>
          {{-- Anda bisa mengubah 'Dashboard' menjadi dinamis berdasarkan halaman saat ini --}}
        ...
        <ul class="navbar-nav justify-content-end">
          ...
          <li class="nav-item dropdown d-flex align-items-center me-2">
            <a href="javascript:;" class="nav-link text-body font-weight-bold px-0" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              {{-- Menampilkan nama user yang login, atau 'Guest' jika belum login --}}
          ...
          {{-- Sidenav Toggler (Untuk tampilan mobile, jangan dihapus untuk responsivitas) --}}
